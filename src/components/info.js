...
const Form = () => {
  ...
  return (
    <form onSubmit={sendEmail} style={{ width: "350px" }}>
      {formSubmitted && (
        <p style={{ color: "grey", fontWeight: "bold" }}>Thank you, {name}!</p>
      )}
      <div className="mb-3">
      ...
      <div className="mb-3">
        <label htmlFor="localizacion" className="form-label">
          Localización
        </label>
        <input
          type="text"
    ...
    <div className="info-icons">
      <div className="d-flex flex-column">
        <div className="d-flex flex-row align-items-center">
          ...
          <div>estudio@aliciaagosti.com</div>
        </div>
        <div className="d-flex flex-row align-items-center">
          <a href="tel:+34630199112">
            <img src={phoneSVG} alt="phone" className="svg-icon" />
          </a>
          <div style={{ textDecoration: "none" }}>+34 630 19 91 12</div>
        </div>
        <div className="d-flex flex-row align-items-center">
          <a
          ...
          <div>alicia.agosti.interiorismo</div>
        </div>
      </div>
    </div>
  )
