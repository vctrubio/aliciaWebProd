...
const PortfolioItemTemplate = ({ data, location }) => {
  ...
  const whatsappInquiryUrl = `https://api.whatsapp.com/send?phone=34630199112&text=${encodeURIComponent(`Me gusta ${titleCased}\n${shareUrl}`)}`;
  ...
  return (
    <div style={{ textAlign: 'center', width: '100%', margin: '0 !important', overflow: 'hidden' }}>
      ...
      <div className="container text-center mt-2">
        ...
        <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '20px', marginBottom: '4em' }}>
            ...
            <a href={whatsappInquiryUrl} target="_blank" rel="noopener noreferrer" className='back-btn' aria-label="Consultar por WhatsApp">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path>
                </svg>
            </a>
            <a href={whatsappShareUrl} target="_blank" rel="noopener noreferrer" className='back-btn' aria-label="Compartir">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
...
export const Head = ({ data, location }) => {
  ...
  const imageItem = node.media?.find(m => m.file?.contentType?.startsWith('image/'));
